...
try {
  ...
  robocopy $production $backupCode /E /COPY:DAT /DCOPY:DAT /R:2 /W:1 `
    /XD '.git' 'node_modules' 'logs' 'data' 'modules\tk-creator-system\data' 'modules\tk-trend-system\data' 'modules\product-test-system\data' 'modules\ai-image-system\data' 'ai-image-system\data' 'product-test-system\data' `
  ...
  robocopy $releaseDir $production /E /COPY:DAT /DCOPY:DAT /R:2 /W:1 `
    /XD 'node_modules' 'logs' 'data' 'modules\tk-creator-system\data' 'modules\tk-trend-system\data' 'modules\product-test-system\data' 'modules\ai-image-system\data' 'ai-image-system\data' 'product-test-system\data' `
    /XF '.env' '*.log' '*.db' '*.db-wal' '*.db-shm' | Out-Host
