...
tar \
  ...
  --exclude='modules/tk-trend-system/data' --exclude='modules/product-test-system/data' --exclude='modules/ai-image-system/data' --exclude='ai-image-system/data' --exclude='product-test-system/data' \
...
tar \
  ...
  --exclude='modules/product-test-system/data' --exclude='modules/ai-image-system/data' --exclude='ai-image-system/data' --exclude='product-test-system/data' --exclude='*.log' --exclude='*.db' --exclude='*.db-wal' --exclude='*.db-shm' \
